...
#     thisContrast.xi <- tmp[[theContrasts[j]]]$xi
#     thisContrast.xibar <- tmp[[theContrasts[j]]]$xibar
#     nrecs <- dim(thisContrast.xibar)[1]
#     prob <- apply(thisContrast.xi,2,
#                   function(x){
#                     mean(x>0)*100
#                   })
#     outContrasts[[j]] <- data.frame(who=rep(thisContrast.name,nrecs),
#                                     date=rownames(thisContrast.xibar),
#                                     xibar=thisContrast.xibar[,"mean"]*100,
#                                     lo=thisContrast.xibar[,"2.5"]*100,
#                                     up=thisContrast.xibar[,"97.5"]*100,
#                                     prob=prob)
  }
